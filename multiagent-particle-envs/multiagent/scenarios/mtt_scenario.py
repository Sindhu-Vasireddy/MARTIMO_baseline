...
class Scenario(BaseScenario):
    ...
    def reset_world(self, world):
        ...
        max_range=np.inf) for i in range(3)]
        ...
        yps = range(0, 100, 10)  
        # constant velocities of the targets with direction
        xdirection = [1.00, -1.25, 1.00, 1.25, -1.00, -1.25]
        ydirection = [1.25, -1.00,-1.25, 1.00, -1.25, 1.00]
    ...
    def observation(self, agent, world):
        ...
        # print("observation is np array of shape :",observation.shape," with values:",observation)
